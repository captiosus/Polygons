...
def draw_polygons(points, screen, color):
    ...
    while p < len(points) - 2:
        a = [points[p+1][0]-points[p][0], points[p+1][1]-points[p][1], points[p+2][2]-points[p][2]]
        ...
        if n[0]*v[0]+n[1]*v[1]+n[2]*v[2] < 0:
            ...
            draw_line(screen, points[p + 1][0], points[p + 1]
                      [1], points[p + 2][0], points[p + 2][1], color)
            draw_line(screen, points[p][0], points[p][1],
...
def add_sphere(points, cx, cy, cz, r, step):
    ...
    while lat < lat_stop-1:
        ...
        while longt < longt_stop-1:
            ...
            add_polygon(points, temp[index][0], temp[index][1], temp[index][2], temp[index+1][0], temp[index+1][1], temp[index+1][2], temp[index + num_steps + 1][0], temp[index + num_steps + 1][1], temp[index + num_steps + 1][2])
...
def add_torus(points, cx, cy, cz, r0, r1, step):
    ...
    while lat < lat_stop:
        ...
        while longt < longt_stop-1:
            index = lat * num_steps + longt
            if lat == lat_stop-1:
                add_polygon(points, temp[index][0], temp[index][1], temp[index][2], temp[longt][0], temp[longt + 1][1], temp[longt + 1][2], temp[longt][0], temp[longt][1], temp[longt][2])
                add_polygon(points, temp[index][0], temp[index][1], temp[index][2], temp[index+1][0], temp[index+1][1], temp[index+1][2], temp[longt + 1][0], temp[longt + 1][1], temp[longt + 1][2])
            else:
                add_polygon(points, temp[index][0], temp[index][1], temp[index][2], temp[index + num_steps + 1][0], temp[index + num_steps + 1][1], temp[index + num_steps + 1][2], temp[index + num_steps][0], temp[index + num_steps][1], temp[index + num_steps][2])
                add_polygon(points, temp[index][0], temp[index][1], temp[index][2], temp[index+1][0], temp[index+1][1], temp[index+1][2], temp[index + num_steps + 1][0], temp[index + num_steps + 1][1], temp[index + num_steps + 1][2])
            longt += 1
